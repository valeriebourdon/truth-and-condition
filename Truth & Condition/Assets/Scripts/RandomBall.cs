...
public class RandomBall : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // float x =  Mathf.PerlinNoise(Mathf.Sin(Random.value), Mathf.Cos(Random.value) ) * 0.1f - 1.0f;
        // float y =  Mathf.PerlinNoise(Mathf.Cos(Random.value), Mathf.Tan(Random.value) ) * 0.1f - 1.0f;
        // float z =  Mathf.PerlinNoise(Mathf.Tan(Random.value), Mathf.Sin(Random.value) ) * 0.1f - 1.0f;
        float x =  0;
        float y =  0;
        float z =  Mathf.PerlinNoise(Mathf.Tan(Random.value), Mathf.Sin(Random.value) ) * 0.1f;
